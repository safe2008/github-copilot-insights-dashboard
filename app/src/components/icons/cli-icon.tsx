/**
 * GitHub Copilot CLI icon (octicon-terminal).
 * Matches the Lucide icon component API for drop-in replacement.
 */
import type { SVGProps } from "react";

export function CliIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
